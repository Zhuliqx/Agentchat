...
> 面向简历 / 面试准备的**精选内容**，从工程文档中抽出集中管理；工程文档保持精简。
> 最后校验：2026-08-29

| 主题 | 文档 | 来源 |
|------|------|------|
| 简历项目 One-pager（两项目速览 + 电梯演讲） | [one-pager](one-pager.md) | 项目自述 |
...
> 建议顺序：One-pager（30 秒开场）→ star-stories（3 个讲熟）→ rag-qa / system-design（被追问时用）。
